 ...
 ************************************************************************
 */
BOOST_AUTO_TEST_SUITE(bounding_box_4_suite)
...
BOOST_AUTO_TEST_CASE(constructor_1)
{
	...
	for (int i = 0; i < 6; i+=2) {
		...
		BOOST_CHECK(bb.bounds[i+1][0] == -std::numeric_limits<float>::infinity() &&
...
BOOST_AUTO_TEST_CASE(constructor_2)
{
	...
	BOOST_CHECK(bb.bounds[0][2] == 3.0);
	BOOST_CHECK(bb.bounds[0][3] == 4.0);

	BOOST_CHECK(bb.bounds[1][0] == 13.0);
	BOOST_CHECK(bb.bounds[1][1] == 14.0);
	BOOST_CHECK(bb.bounds[1][2] == 15.0);
	BOOST_CHECK(bb.bounds[1][3] == 16.0);

	BOOST_CHECK(bb.bounds[2][0] == 5.0);
	BOOST_CHECK(bb.bounds[2][1] == 6.0);
	BOOST_CHECK(bb.bounds[2][2] == 7.0);
	BOOST_CHECK(bb.bounds[2][3] == 8.0);

	BOOST_CHECK(bb.bounds[3][0] == 17.0);
	BOOST_CHECK(bb.bounds[3][1] == 18.0);
	BOOST_CHECK(bb.bounds[3][2] == 19.0);
	BOOST_CHECK(bb.bounds[3][3] == 20.0);

	BOOST_CHECK(bb.bounds[4][0] == 9.0);
	BOOST_CHECK(bb.bounds[4][1] == 10.0);
	BOOST_CHECK(bb.bounds[4][2] == 11.0);
	BOOST_CHECK(bb.bounds[4][3] == 12.0);

	BOOST_CHECK(bb.bounds[5][0] == 21.0);
	BOOST_CHECK(bb.bounds[5][1] == 22.0);
	BOOST_CHECK(bb.bounds[5][2] == 23.0);
	BOOST_CHECK(bb.bounds[5][3] == 24.0);
}
